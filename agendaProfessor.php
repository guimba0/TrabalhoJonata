...
require_once 'conexaoBancoDados.php'; // Certifique-se de que este arquivo existe e funciona
session_start();
    ...
    <main>
        ...
        <?php else: ?>
            <table class="nao-agendados-table">
                ...
                <tbody>
                    <?php foreach ($tccs_orientados_sem_agendamento as $tcc): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($tcc['titulo']); ?></td>
                            <td>
                                <?php
                                $alunos_tcc = [];
                                if (!empty($tcc['aluno1_nome'])) $alunos_tcc[] = $tcc['aluno1_nome'];
                                if (!empty($tcc['aluno2_nome'])) $alunos_tcc[] = $tcc['aluno2_nome'];
                                if (!empty($tcc['aluno3_nome'])) $alunos_tcc[] = $tcc['aluno3_nome'];
                                echo implode(', ', $alunos_tcc);
                                ?>
                            </td>
